...
@section('content')
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2">
                <div class="card-header mb-0">
                    <h4 class="mb-0">{{ __('Realisasi Tahun Berjalan') }}</h4>
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>Grafik Dana Desa</h6>

                </div>
                <div class="card-body p-3">
                    <div class="chart">
                        <canvas id="chart2" class="chart-canvas" height="500"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header mb-0">
                    <h6 class="mb-0">{{ __('Realisasi Per Tahun') }}</h6>
                </div>
                <div class="card-body p-3">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <div class="chart">
                            <canvas id="chart-pertahun" class="chart-canvas" height="300"></canvas>
                        </div>
                    </div>
                    <h6>Peringkat</h6>
                        ...
                        <div class="row">
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Bongo</p>
                                </div>
                                <h4 class="font-weight-bolder">Rp. 1M</h4>
                            ...
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Buhudaa</p>
                                </div>
                                <h4 class="font-weight-bolder">Rp. 2M</h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Lopo</p>
                                </div>
                                <h4 class="font-weight-bolder">Rp. 1M</h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Kayubulan</p>
                                </div>
                                <h4 class="font-weight-bolder">Rp. 2M</h4>
                                <div class="progress w-75">
...
@push('dashboard')
    <script>
        var labels = @json($totalsDesa->pluck('nama_desa'));
        ...
        var anggaranData = @json($totalsDesa->pluck('total_anggaran'));
            var seluruhDesa = @json($seluruhDesa);
        ...
        window.onload = function() {
            ...
            // var ctx3 = document.getElementById("chart-pertahun").getContext("2d");
            ...
            //     type: "line",
            //     data: {
            //         labels: ["Bongo", "Buhudaa", "Lopo", "Kayubulan", "Biluhu Timur", "Tontayuo", "Langgula",
            //             "Lamu", "Limoo'o"
            //         ],
            //         datasets: [{
            //                 label: "Anggaran",
